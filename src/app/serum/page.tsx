  ...
  return (
    <div className="bg-gray-100 min-h-screen p-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold">Healthy Glow Anti-Aging Serum</h1>
        <p className="text-gray-600">Turn back time and rejuvenate your skin!</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-6">
        ...
        <div className="bg-white w-full md:w-1/3 p-4 rounded-lg shadow-lg hover:shadow-2xl transition-all">
          <Image
            ...
            src="/antiagingserum.jpg" // Replace with the actual image path
            alt="Healthy Glow Anti-Aging Serum"
            width={500} // Specify the image width
            height={500} // Specify the image height
          />
          <div className="text-center">
            <h2 className="text-lg font-bold mb-2">Healthy Glow Anti-Aging Serum</h2>
            <p className="text-sm text-gray-600">Price: PKR 2500</p>
          </div>
        </div>
        ...
        <div className="bg-white w-full md:w-2/3 p-6 rounded-lg shadow-md">
          ...
          <ul className="list-disc ml-6 mb-6 text-gray-700">
            ...
            <li>Promotes a youthful and glowing complexion</li>
          </ul>
          ...
          <ul className="list-disc ml-6 mb-6 text-gray-700">
            ...
            <li>Dry, aging, or dull skin</li>
          </ul>

          <h2 className="text-2xl font-bold mb-4">How to Apply</h2>
          <ul className="list-disc ml-6 text-gray-700">
            <li>Apply a few drops to clean, dry skin</li>
            <li>Massage gently into the face and neck</li>
